...
public class Controller {
	...
	public void start() { // 메인 화면
		...
		do {
			...
			System.out.println("-----------------------------------------------------------------------");
			System.out.println(
					"1.로그인" + "\t" + "2.회원가입" + "\t" + "3.노래 검색" + "\t" + " 4.차트보기" + "\t" + "5.노래추천 게시판" + "\t" +"6. 공지사항"+ " 0.종료");
			System.out.println("-----------------------------------------------------------------------");
	...
	private void start1() {
		...
		do {
			...
			System.out.println("0. 로그인"); // 없애고
			System.out.println("1. 노래 리스트 보기");  // 회원,비회원, 관리자
			System.out.println("2. 노래 검색"); // 회원, 비회원, 관리자
			System.out.println("3. 노래 추가"); // 관리자
			System.out.println("4. 노래 삭제"); // 관리자
			System.out.println("5. 최근 들은 플레이리스트 보기"); // 회원
			...
			case 0:
				...
				break;
			case 1:
				musicService.MusicList(); // 저장된 음악 리스트 보기ㅣ
				break;
			case 2:
				musicService.searchMusic(); // 노래검색
				break;
			case 3:
				musicService.InsertMusic(); // 노래추가
				break;
			case 4:
				musicService.deleteMusic(); // 노래삭제
				break;
			case 5:
				musicService.Show_R_musicList(); // 최근 들은 노래 리스트 확인
				break;
			case 6:
				musicService.Show_MusicList(); // 플레이리스트 확인
				break;
			}
		} while (menu != 9);
